...
import org.grid2osm.gisapp.greenDao.DaoMaster;
import org.grid2osm.gisapp.greenDao.DaoMaster.DevOpenHelper;
import org.grid2osm.gisapp.greenDao.DaoSession;
import org.grid2osm.gisapp.greenDao.LocationEntities;
import org.grid2osm.gisapp.greenDao.LocationEntitiesDao;
import org.grid2osm.gisapp.greenDao.LocationEntity;
import org.grid2osm.gisapp.greenDao.LocationEntityDao;
import org.grid2osm.gisapp.greenDao.PhotoEntities;
import org.grid2osm.gisapp.greenDao.PhotoEntitiesDao;
import org.grid2osm.gisapp.greenDao.PhotoEntity;
import org.grid2osm.gisapp.greenDao.PhotoEntityDao;
import org.grid2osm.gisapp.greenDao.PoiEntities;
import org.grid2osm.gisapp.greenDao.PoiEntitiesDao;
import org.grid2osm.gisapp.greenDao.PoiEntity;
import org.grid2osm.gisapp.greenDao.PoiEntityDao;
import org.grid2osm.gisapp.greenDao.PrimitiveAttributesEntity;
import org.grid2osm.gisapp.greenDao.PrimitiveAttributesEntityDao;
...
public class MainActivity extends ActionBarActivity implements
    ...
    private void restorePrimitiveFromDB() {
        ...
        if (primitiveAttributesEntities.size() > 0) {
            ...
            Integer progressBarVisibility = primitiveAttributesEntity
                    .getProgressBar();
            if (progressBarVisibility == View.GONE) {
                progressBar.setVisibility(View.GONE);
            } else if (progressBarVisibility == View.VISIBLE) {
                progressBar.setVisibility(View.VISIBLE);
            }

            Integer progressCircleVisibility = primitiveAttributesEntity
                    .getProgressCircle();
            if (progressCircleVisibility == View.GONE) {
                progressCircle.setVisibility(View.GONE);
            } else if (progressCircleVisibility == View.VISIBLE) {
                progressCircle.setVisibility(View.VISIBLE);
            }
