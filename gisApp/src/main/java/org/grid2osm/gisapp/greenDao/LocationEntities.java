...
/**
 * Entity mapped to table LOCATION_ENTITIES.
 */
public class LocationEntities {
    ...
    private transient LocationEntitiesDao myDao;
    ...
    public LocationEntities(Long id) {
        this.id = id;
    }
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getLocationEntitiesDao() : null;
    }
    ...
    public List<LocationEntity> getLocationEntityList() {
        if (locationEntityList == null) {
            ...
            List<LocationEntity> locationEntityListNew = targetDao._queryLocationEntities_LocationEntityList(id);
            synchronized (this) {
                if(locationEntityList == null) {
